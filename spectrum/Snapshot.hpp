...
public:
  ...
  static void load(const std::filesystem::path &snapshot, Z80Impl &z80) {
...
private:
  ...
  static constexpr auto RamSnapshotSize = 48 * 1024;
  static constexpr auto ExpectedSize = RamSnapshotSize + sizeof(SnapshotHeader);
};
