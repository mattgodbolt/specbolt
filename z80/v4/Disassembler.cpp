...
// The whole of the Z80's part in disassembling itself: say where the bytes come from. Following prefixes, applying a
// view's renaming and rendering the lowered pieces are all facts about the description rather than about this chip, so
// `refract` does them for any description.
