...
struct OpcodeTester {
  Clock clock;
  Memory memory{4};
  v1::Z80 z80{clock, memory};
  static constexpr auto use_new_code = false;
...
TEST_CASE_METHOD(OpcodeTester, "Unprefixed opcode execution tests", "[opcode][generated]") {
  OpcodeTester::unprefixed();
}
