...
export class Wasi {
    ...
    args_get(argsPtr, argBufferPtr) {
        ...
        const argsPointerBuffer =
            new Uint32Array(this.#instance.exports.memory.buffer, argsPtr, this.#argEncodedStrings.length);
    ...
    environ_get(environPtr, environBufferPtr) {
        ...
        const environsPointerBuffer =
            new Uint32Array(this.#instance.exports.memory.buffer, environPtr, this.#envEncodedStrings.length);
